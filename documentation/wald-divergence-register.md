...
| WD-61 | CustomerApp-specific product semantics | CAS and FLU are Windows; PFD is Doors. GLS/WP/MISC remain excluded from customer product projection with private raw evidence. Approved irrelevant Call Type rows remain excluded. Dictionary v8 stales former knowledge. | DEC-075; small real workbook Plot 591 and synthetic projection tests. Feature branch only; no SiteApp backport, migration, production import or deployment. Supersedes historical WD-16 CAS/FLU/PFD exclusion. |
