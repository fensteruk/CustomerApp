...
{
    public const ABILITIES = ['binding_draft', 'binding_activate', 'binding_revoke', 'binding_correct', 'binding_audit', 'upload', 'analyse', 'reanalyse', 'clarify', 'review', 'commit', 'audit', 'retry'];
