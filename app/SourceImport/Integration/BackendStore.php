...
final class BackendStore
{
    ...
    public const IDENTITY = ['application' => 'customerapp.wald-import-backend.pilot-v4', 'projection' => 'customerapp.wald-source-projection.v4',
        'hashing' => 'customerapp.wald-transient-evidence-digest.v3', 'max_rows' => self::MAX_ROWS];
