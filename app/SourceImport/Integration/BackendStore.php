...
final class BackendStore
{
    ...
    public const IDENTITY = ['application' => 'customerapp.wald-import-backend.v1', 'projection' => 'customerapp.wald-source-projection.v1',
        'hashing' => 'customerapp.wald-transient-evidence-digest.v1', 'max_rows' => self::MAX_ROWS];
